...
# JSight Schema Go Library
  ...
  [![License](https://img.shields.io/github/license/jsightapi/jsight-schema-go-library?colorB=ff0000)](./LICENSE)
...
```
git clone https://github.com/jsightapi/jsight-schema-go-library
```
...
https://github.com/jsightapi/jsight-schema-go-library/releases.
...
- GitHub discussions: https://github.com/jsightapi/jsight-schema-go-library/discussions.
